...
cfg.train_df = cfg.data_dir + "fire_train_sample_T0.csv"
cfg.valid_df = cfg.data_dir + "fire_valid_sample_T0.csv"
cfg.test_df = cfg.data_dir + "fire_valid_sample_T0.csv"
...
cfg.layer_windows = {
    ...
    "firms_recency": (0, 1),
    "firms_current": (0, 13),
    "burn": (1, 13),  # can not use current burn as a feature
}
